...
function writeCompletedTodos() {
  document.getElementById("completedTodos").innerHTML = null; //Adder først headingene: Gjør programmatisk sånn at en ikke sletter disse når funksjonen kalles på ny.
  ...
  headingRow.appendChild(headingAuthor);
...
function completeTodo(id) {
  ...
  for (i = 0; i < todos.length; i++) {
    if (todos[i].id == id) {
      ...
      completedTodos.push(completedObject); //Slett den fra todos
